...
TRAINING_DATA = {
    ...
    "support_ticket": [
        "create support ticket", "support ticket", "i need support",
        "open a ticket", "raise a ticket", "submit a ticket",
        "report a problem", "report an issue", "report a bug",
        "i have a problem", "i have an issue", "something is broken",
        "system not working", "bug report", "technical issue",
        "need help with system", "need technical support",
        "contact support", "support request", "help ticket",
        "create ticket", "new ticket", "open ticket", "raise issue",
        "file a complaint", "file complaint", "submit issue",
        "support team", "talk to support", "reach support",
        "need creat support ticket", "i need to create support ticket",
        "create a support ticket", "make a support ticket",
        "I need support ticket", "support ticket hadanna",
        "ticket ekak hadanna", "ticket ekak open karanna",
        "problem report karanna", "issue report karanna",
        "system problem", "app not working", "portal issue",
        "something wrong", "not working properly", "broken feature",
        "cant login", "login problem", "payment issue",
        "billing problem", "account problem", "feature not working",
        "error in system", "getting error", "system error",
        "bug in app", "please help", "i need assistance",
        "escalate issue", "urgent support", "critical issue",
        "ticket open karanna", "support ticket create karanna",
    ],
