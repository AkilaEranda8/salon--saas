...
async function ensureStaffSpecCommissionColumns() {
  try {
    ...
    const columnsWereMissing = !tableDesc.commission_type || !tableDesc.commission_value;
    // One-time backfill only when columns were just added — do not overwrite existing rates on restart.
