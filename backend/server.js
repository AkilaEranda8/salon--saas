...
const ensurePaymentHelperCommissionColumn = require('./services/ensurePaymentHelperCommissionColumn');
...
const ensureExpenseCategoryFlexible = require('./services/ensureExpenseCategoryFlexible');
...
connectWithRetry().then(async () => {
  ...
  await ensurePaymentHelperCommissionColumn();
  ...
  await ensureExpenseCategoryFlexible();
