...
const { attachPaymentCommissionTotals, paymentTotalCommission, parseJsonField } = require('../utils/paymentCommissionTotals');
...
/** Attach all booked services + per-service staff for payment list/detail views. */
