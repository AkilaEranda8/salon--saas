...
= 1.0.22 =
* Full plugin harden: Elementor-safe boot, scoped widget DOM, safer AJAX errors, service ID matching fix.
* Show clear error if booking.js fails to start instead of hanging on "Preparing…".
